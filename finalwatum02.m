...
dt = 30; % MATLAB will waits here and you can change the dt with the value in excel setting sheet.
...
for i =  1 : Reach_ID 
        ...
        clc;
        fprintf('Progress ... %8.5f ', (i*100)/Reach_ID);
   
    for  t = 1  : nT -1
        
        fprintf('Progress ... %8.5f ', (t*100)/nT);
