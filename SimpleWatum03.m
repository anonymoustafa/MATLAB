...
if     LCD_num == 1
        LCD0 = fischer(b,y,z,s,q,u) ;
elseif LCD_num == 2
        LCD0 = seo(b,y,z,s,q,u) ;
elseif LCD_num == 3
        LCD0 = deng(b,y,z,s,q,u) ;
elseif LCD_num == 4
        LCD0 = kashefipour(b,y,z,s,q,u) ;
elseif LCD_num == 5
        LCD0 = rajeev(b,y,z,s,q,u) ;
elseif LCD_num == 6
        LCD0 = jhang(b,y,z,s,q,u) ;
elseif LCD_num == 7
        LCD0 = qiasi(b,y,z,s,q,u) ;
elseif LCD_num == 8
        LCD0 = 0 ;        
end 
...
fprintf(formatSpec,total_time,nT,nX,cor,Landa,dt,dx,LCD0,epr)
pause()
%% main solver
tic
for t = 2 : 1 : nT -1
